  ...
  >
    ...
    >
      ...
      <template #badmintonMixedDouble>
        <standing-group :groups="getSportGroup(badmintonMixedDoubleTeams)" :playoff="getPlayoffTeams('badmintonMixedDouble')" bracket="semi"/>
      </template>
      <template #basketball>
      ...
      <template #futsal>
        <standing-group :groups="getSportGroup(futsalTeams)" :playoff="getPlayoffTeams('futsal')" bracket="quarter"/>
      </template>
    </UTabs>
  </div>
</template>
